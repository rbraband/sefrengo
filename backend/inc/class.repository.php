<?PHP
// File: $Id: class.repository.php 595 2011-12-18 22:15:26Z bjoern $
// +----------------------------------------------------------------------+
...
class repository {
    ...
    */
    function repository() {
        global $perm, $cfg_cms, $db, $cms_db, $cms_lang, $auth, $client, $lang, $sess;
        // get global values
        ...
        $this->_plugin_dir = $this->_cms_var['path_base'] . $this->_cms_var['path_backend_rel'] . 'plugins/';
        // get global config
