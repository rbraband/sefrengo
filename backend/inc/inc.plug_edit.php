<?PHP
// File: $Id: inc.plug_edit.php 616 2012-01-11 00:09:29Z holger $
// +----------------------------------------------------------------------+
...
echo "<div id=\"main\">\n";
    ...
    if (is_numeric($idplug)) {
        ...
        $filecontent = $rep->_file($cfg_cms['path_base'].$cfg_cms['path_backend_rel'] . 'plugins/' . $name . '/' . $name . '.cmsplug');
...
echo "    <table class=\"config\" cellspacing=\"1\">\n";
    ...
    if (!$noeditfield) {
        echo "<label for=\"catchange\">".$cms_lang['gen_select']."</label> <select onchange=\"document.newplugin.plugcat.value=(this.value);\" name=\"catchange\" id=\"catchange\" size=\"1\">\n";
