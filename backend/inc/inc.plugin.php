<?PHP
// File: $Id: inc.plugin.php 595 2011-12-18 22:15:26Z bjoern $
// +----------------------------------------------------------------------+
...
$plugin_var = pathinfo($cfg_cms['path_base'].$cfg_cms['path_backend_rel'] .'plugins/'. $cms_plugin);
...
if (!$is_frame_plugin) {
	include($cfg_cms['path_base'].$cfg_cms['path_backend_rel'] . 'inc/inc.header.php');
}

if(is_file($cfg_cms['path_base'].$cfg_cms['path_backend_rel'] .'plugins/'. $cms_plugin)) {
	include $cfg_cms['path_base'].$cfg_cms['path_backend_rel'] .'plugins/'. $cms_plugin;
} else {
