<?PHP
// File: $Id: fnc.mipforms.php 507 2011-10-23 00:23:40Z holger $
// +----------------------------------------------------------------------+
 ...
 *
 *
 * @Author: (c) Bj�rn Brockmann 2002 - 2003
...
*					  ['tab']  (Einr�ckung Ausnahme 'hidden')
*
*                NUR $in['type'] = 'chk', 'chk_long'
*                 ['chk_var'] (Checkboxvariable)
*                 ['chk_val'] (Checkboxwert  "1" f�r angeklickt)
...
*                NUR $in['type'] = 'option'
*                 ['size'] (optional default ='1') (Gr��e des <select>- Tags)
*                 ['flag'] (optional) (M�glicher Wert = 'multiple', wenn ['size'] > 1)
*                NUR $in['cat'] = 'chk'
