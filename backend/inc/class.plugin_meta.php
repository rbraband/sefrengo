<?PHP
// File: $Id: class.plugin_meta.php 595 2011-12-18 22:15:26Z bjoern $
// +----------------------------------------------------------------------+
...
class plugin_meta {
	...
	*/
    ...
    function load_langstrings()
    {
    	...
    	$lang_file = $cfg_cms['path_base'].$cfg_cms['path_backend_rel'].'plugins/'.$this->root_name.'/lang/'.$cfg_cms['backend_lang'].'/lang_general.php';
		$lang_default_file = $cfg_cms['path_base'].$cfg_cms['path_backend_rel'].'plugins/'.$this->root_name.'/lang/de/lang_general.php';
