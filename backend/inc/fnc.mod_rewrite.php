...
function rewriteGenerateMapping($idlang = false) {
	...
	//echo $cfg_cms['path_base'].$cfg_cms['path_backend_rel'].'lang/urlfilter/'.$mapping_file;
	if (is_file($cfg_cms['path_base'].$cfg_cms['path_backend_rel'].'lang/urlfilter/'.$mapping_file)) {
		$rewrite_mapping_raw = file($cfg_cms['path_base'].$cfg_cms['path_backend_rel'].'lang/urlfilter/'.$mapping_file);
	} else {
		$rewrite_mapping_raw = file($cfg_cms['path_base'].$cfg_cms['path_backend_rel'].'lang/urlfilter/standard.php');
	}
