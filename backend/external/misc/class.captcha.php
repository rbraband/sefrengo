	...
	class captcha
	{
		...
		function _generate_image( $location, $char_seq )
		{
			...
			switch ($this->style)
			{
				...
				$ttfont=$cfg_cms['path_base'].$cfg_cms['path_backend_rel'].'tpl/fonts/courierbold.ttf';
				...
				$ttfont=$cfg_cms['path_base'].$cfg_cms['path_backend_rel'].'tpl/fonts/pixelate.ttf';
				...
				$ttfont=$cfg_cms['path_base'].$cfg_cms['path_backend_rel'].'tpl/fonts/timesnewromanbold.ttf';
				$fontsize = $this->height/1.7;
				$fx_strength=$fontsize;
				$ts=imagettfbbox($fontsize, 0, $ttfont, "M" );
				$ttfchar_height=-$ts[5];
