...
$cms_lang['area_mod']					= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; Installed modules</b>';
$cms_lang['area_mod_new']				= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; New module</b>';
$cms_lang['area_mod_edit']				= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; Edit module</b>';
$cms_lang['area_mod_edit_sql']	    	= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; Edit module-sql</b>';
$cms_lang['area_mod_config']			= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; Configure module</b>';
$cms_lang['area_mod_import']			= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; Import module</b>';
$cms_lang['area_mod_duplicate']	    = '<b>'.$cms_lang['nav_2_0'].' &rsaquo; Copy module</b>';
$cms_lang['area_mod_xmlimport']		= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; Import XMS style module</b>';
$cms_lang['area_mod_xmlexport']		= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; Export XMS style module</b>';
$cms_lang['area_mod_database']         = $cms_lang['area_mod_import'] . ' <b>&rsaquo; Database</b>';
$cms_lang['area_mod_repository']       = $cms_lang['area_mod_import'] . ' <b>&rsaquo; Repository</b>';

$cms_lang['area_plug']					= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; Installed plugins</b>';
$cms_lang['area_plug_new']		    	= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; New plugin</b>';
...
$cms_lang['area_plug_edit']			= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; Edit plugin</b>';
$cms_lang['area_plug_edit_sql']	    = '<b>'.$cms_lang['nav_3_0'].' &rsaquo; Edit plugin meta data</b>';
$cms_lang['area_plug_config']			= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; Configure plugin</b>';
$cms_lang['area_plug_import']			= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; Import plugin</b>';
$cms_lang['area_plug_folder']          = $cms_lang['area_plug_import'] . ' <b>&rsaquo; Folder</b>';
$cms_lang['area_plug_repository']      = $cms_lang['area_plug_import'] . ' <b>&rsaquo; Repository</b>';

$cms_lang['area_con']					= '<b>'.$cms_lang['nav_1_0'].' &rsaquo; '.$cms_lang['nav_1_1'].'</b>';
$cms_lang['area_con_configcat']		= '<b>'.$cms_lang['nav_1_0'].' &rsaquo; Configure folder</b>';
$cms_lang['area_con_configside']		= '<b>'.$cms_lang['nav_1_0'].' &rsaquo; Configure page</b>';
$cms_lang['area_con_edit']				= ''.$cms_lang['nav_1_0'].' &rsaquo; Edit page';
...
$cms_lang['area_lay_edit']				= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; Edit layout</b>';

$cms_lang['area_css']					= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_2'].'</b>';
$cms_lang['area_css_edit']				= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_2'].' &rsaquo; Edit css rule</b>';
$cms_lang['area_css_edit_file']		= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_2'].' &rsaquo; Edit css file</b>';
$cms_lang['area_css_new_file']			= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_2'].' &rsaquo; Ereate css file</b>';
$cms_lang['area_css_import']			= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_2'].' &rsaquo; Import css rule</b>';

$cms_lang['area_js']					= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_3'].'</b>';
$cms_lang['area_js_edit_file']			= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_3'].' &rsaquo; Edit javascript file</b>';
$cms_lang['area_js_import']			= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_3'].' &rsaquo; Import javascript file</b>';

$cms_lang['area_tpl']					= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_5'].'</b>';
$cms_lang['area_tpl_edit']				= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; Edit template</b>';

$cms_lang['area_user']					= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; '.$cms_lang['nav_3_1'].'</b>';
$cms_lang['area_user_edit']   			= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; Edit user</b>';
$cms_lang['area_group']				= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; '.$cms_lang['nav_3_2'].'</b>';
$cms_lang['area_group_edit']			= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; Edit group</b>';
$cms_lang['area_group_config']			= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; Configure group</b>';
$cms_lang['area_lang']					= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; '.$cms_lang['nav_3_3'].'</b>';
$cms_lang['area_settings']				= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; Project preferences</b>';
...
$cms_lang['gen_font']					= 'Font';
$cms_lang['gen_errorfont']				= 'Font for error message';
$cms_lang['gen_inputformfont']			= 'Font for input field';
$cms_lang['gen_picforsend']				= 'Image for send button';
$cms_lang['gen_select']					= 'Select';
$cms_lang['gen_select_actions']	    = 'Actions&hellip;';
$cms_lang['gen_select_view'] 		  	= 'View&hellip;';
$cms_lang['gen_select_change_to']	  	= 'Change to&hellip;';
$cms_lang['gen_help']                  = 'Help';
$cms_lang['gen_logout_wide']           = 'Logout';
$cms_lang['gen_user']			        = 'User: ';
$cms_lang['gen_reset']			        = 'Reset';
$cms_lang['gen_loading']			    = 'Loading';
...
//contentflex
$cms_lang['cf_add_first_pos']			= 'Insert as first element';
$cms_lang['cf_insert_p1']			= 'Insert after element';
$cms_lang['cf_insert_p2']			= '';

$cms_lang['news_inputname']				= 'Field label';
$cms_lang['news_email']					= 'Email address';
$cms_lang['news_name']					= 'Name (optional)';
$cms_lang['news_subcribe']				= 'Subscribe';
$cms_lang['news_unsubcribe']			= 'Unsubscribe';
$cms_lang['news_both']					= 'both';
$cms_lang['news_headline']				= 'Keep yourself up-to-date.';
$cms_lang['news_headlineback']			= 'Headline';
$cms_lang['news_subcribemessageback']	= 'Subscribe message';
$cms_lang['news_unsubcribemessageback']	= 'Unsubscribe message';
$cms_lang['news_subcribemessage']		= 'Your subscription was successfully.';
$cms_lang['news_unsubcribemessage']		= 'Your subscription was successfully deleted.';
$cms_lang['news_stopmessage']			= 'Your subscription was deactivated.';
$cms_lang['news_goonmessage']			= 'Your subscription was activated.';
$cms_lang['news_err_1001']				= 'Missing email address.';
$cms_lang['news_err_1002']				= 'Error in email address.';
$cms_lang['news_err_1003']				= 'Email address already in use.';
$cms_lang['news_err_1004']				= 'Email address not found.';


$cms_lang['login_error']				= 'Error message';
$cms_lang['login_errormsg']				= 'login information incorrect.';
$cms_lang['login_send']					= 'Login now';
$cms_lang['login_sendout']				= 'Logout';
$cms_lang['login_name']					= 'Please enter login name';
$cms_lang['login_password']				= 'Pplease enter password';
$cms_lang['login_login']				= 'Login - click here';
$cms_lang['login_logout']				= 'Logout - click here';
$cms_lang['login_picforlogout']			= 'Image of logout button';

$cms_lang['link_extern']				= 'external link';
$cms_lang['link_intern']				= 'internal link';
$cms_lang['link_blank']					= 'open link in new window (_blank)';
$cms_lang['link_self']					= 'open link in same window (_self)';
$cms_lang['link_parent']	  			= 'open link in parent frame (_parent)';
$cms_lang['link_top']					= 'open link in top frame (_top)';
$cms_lang['link_edit']					= 'edit link';

$cms_lang['type_text']					= 'Text';
$cms_lang['type_textarea']				= 'Textarea';
$cms_lang['type_wysiwyg']				= 'WYSIWYG';
$cms_lang['type_link']					= 'Link';
$cms_lang['type_file']					= 'File link';
...
$cms_lang['type_edit_folder']			= 'Folder';
$cms_lang['type_save']					= 'save';
$cms_lang['type_edit']					= 'edit';
$cms_lang['type_new']					= 'new';
$cms_lang['side_new']					= 'create';
$cms_lang['side_config']				= 'configure';
$cms_lang['side_mode']					= 'mode';
$cms_lang['side_publish']				= 'publish';
$cms_lang['side_delete']				= 'delete';
$cms_lang['side_edit']					= 'edit page';
$cms_lang['side_overview']				= 'page overview';
$cms_lang['side_preview']				= 'preview';
$cms_lang['type_delete']				= 'delete';
$cms_lang['type_up']					= 'up';
$cms_lang['type_down']					= 'down';

$cms_lang['img_edit']					= 'edit image';
$cms_lang['imgdescr_edit']				= 'edit image description';

$cms_lang['err_id']						= 'wrong ID.';
$cms_lang['err_type']					= 'wrong TYPE.';
