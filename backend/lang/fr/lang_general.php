...
$cms_lang['area_mod']					= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_4'].'</b>';
$cms_lang['area_mod_new']				= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; nouveau module</b>';
$cms_lang['area_mod_edit']				= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; &Eacute;diter le module</b>';
$cms_lang['area_mod_edit_sql']	     	= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; &Eacute;diter le module-SQL</b>';
$cms_lang['area_mod_config']	     	= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; Configurer le module</b>';
$cms_lang['area_mod_import']	    	= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; Importer un module</b>';
$cms_lang['area_mod_duplicate']	    = '<b>'.$cms_lang['nav_2_0'].' &rsaquo; Copier un module</b>';
$cms_lang['area_mod_xmlimport']	    = '<b>'.$cms_lang['nav_2_0'].' &rsaquo; Importer un module XML</b>';
$cms_lang['area_mod_xmlexport']	   	= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; Exporter un module comme XML</b>';
$cms_lang['area_mod_database']		    = $cms_lang['area_mod_import'] . ' <b>&rsaquo; Base de donn&eacute;es</b>';
$cms_lang['area_mod_repository']		= $cms_lang['area_mod_import'] . ' <b>&rsaquo; R&eacute;f&eacute;rentiel</b>';

$cms_lang['area_plug']					= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; '.$cms_lang['nav_3_5'].'</b>';
$cms_lang['area_plug_new']		      	= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; nouvelle extension</b>';
...
$cms_lang['area_plug_edit']		 	= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; &Eacute;diter l\'extension</b>';
$cms_lang['area_plug_edit_sql']		= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; &Eacute;diter l\'extension-SQL</b>';
$cms_lang['area_plug_config']		  	= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; Configurer l\'extension</b>';
$cms_lang['area_plug_import']	        = '<b>'.$cms_lang['nav_3_0'].' &rsaquo; Importer l\'extension</b>';
$cms_lang['area_plug_folder']			= $cms_lang['area_plug_import'] . ' <b>&rsaquo; R&eacute;pertoire</b>';
$cms_lang['area_plug_repository']      = $cms_lang['area_plug_import'] . ' <b>&rsaquo; R&eacute;f&eacute;rentiel</b>';

$cms_lang['area_con']					= '<b>'.$cms_lang['nav_1_0'].' &rsaquo; '.$cms_lang['nav_1_1'].'</b>';
$cms_lang['area_con_configcat']	    = '<b>'.$cms_lang['nav_1_0'].' &rsaquo; Configurer le dossier</b>';
$cms_lang['area_con_configside']	   	= '<b>'.$cms_lang['nav_1_0'].' &rsaquo; Configurer la page</b>';
$cms_lang['area_con_edit']				= ''.$cms_lang['nav_1_0'].' &rsaquo; &Eacute;diter la page';

$cms_lang['area_upl']					= '<b>'.$cms_lang['nav_1_0'].' &rsaquo; '.$cms_lang['nav_1_2'].'</b>';

$cms_lang['area_lay']					= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_1'].'</b>';
$cms_lang['area_lay_edit']				= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; &Eacute;diter la mise en page</b>';

$cms_lang['area_css']					= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_2'].'</b>';
$cms_lang['area_css_edit']				= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_2'].' &rsaquo; &Eacute;diter les r&egrave;gles CSS</b>';
$cms_lang['area_css_edit_file']	    = '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_2'].' &rsaquo; &Eacute;diter le fichier CSS</b>';
$cms_lang['area_css_new_file']		 	= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_2'].' &rsaquo; Cr&eacute;er un nouveau fichier CSS</b>';
$cms_lang['area_css_import']			= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_2'].' &rsaquo; Importer r&egrave;gles CSS</b>';

$cms_lang['area_js']					= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_3'].'</b>';
$cms_lang['area_js_edit_file']			= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_3'].' &rsaquo; &Eacute;diter fichier Javascript</b>';
$cms_lang['area_js_import']			= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_3'].' &rsaquo; Importer fichier Javascript</b>';

$cms_lang['area_tpl']					= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; '.$cms_lang['nav_2_5'].'</b>';
$cms_lang['area_tpl_edit']				= '<b>'.$cms_lang['nav_2_0'].' &rsaquo; &Eacute;diter le mod&egrave;le</b>';

$cms_lang['area_user']					= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; '.$cms_lang['nav_3_1'].'</b>';
$cms_lang['area_user_edit']   		   	= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; &Eacute;diter l\'utilisateur</b>';
$cms_lang['area_group']			 	= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; '.$cms_lang['nav_3_2'].'</b>';
$cms_lang['area_group_edit']		 	= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; &Eacute;diter le groupe</b>';
$cms_lang['area_group_config']		 	= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; Configurer le groupe</b>';
$cms_lang['area_lang']					= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; '.$cms_lang['nav_3_3'].'</b>';
$cms_lang['area_settings']				= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; R&egrave;glages du syst&egrave;me</b>';
$cms_lang['area_settings_general']	  	= '<b>'.$cms_lang['nav_3_0'].' &rsaquo; '.$cms_lang['nav_3_4'].'</b>';
...
$cms_lang['gen_font']					= 'Caract&egrave;re';
$cms_lang['gen_errorfont']				= 'Caract&egrave;re pour message d\'erreur';
$cms_lang['gen_inputformfont']		  	= 'Caract&egrave;re pour formule de saisie';
$cms_lang['gen_picforsend']				= 'Image pour le bouton \'Valider\'';
$cms_lang['gen_select']					= 'Possibilit&eacute;s de choix';
$cms_lang['gen_select_actions']	    = 'Actions&hellip;';
$cms_lang['gen_select_view'] 		    = 'Vue&hellip;';
$cms_lang['gen_select_change_to']	  	= 'Changer&hellip;';
$cms_lang['gen_help']                  = 'Aide';			// to translate
$cms_lang['gen_logout_wide']           = 'D&eacute;connexion';
$cms_lang['gen_user']			        = 'Utilisateur: ';			// to translate
$cms_lang['gen_loading']			    = 'Chargement';			// to translate
...
$cms_lang['gen_permission_denied']		= 'Nicht gen&uuml;gend Rechte um die Aktion auszuf&uuml;hren!';

$cms_lang['gen_select'] = 'Ausw&auml;hlen: ';
...
$cms_lang['gen_filter_reset'] = 'Zur&uuml;cksetzen';

//contentflex
$cms_lang['cf_add_first_pos']			= 'Ins&eacute;rer comme 1er &eacute;l&eacute;ment';
$cms_lang['cf_insert_p1']			    = 'Ins&eacute;rer apr&egrave;s &eacute;l&eacute;ment';
$cms_lang['cf_insert_p2']			    = '';


$cms_lang['news_inputname']				= 'Champ pour les noms';
$cms_lang['news_email']					= 'Adresse de courrier &eacute;lectronique';
$cms_lang['news_name']					= 'Nom (volontaire)';
$cms_lang['news_subcribe']				= 'connecter';
$cms_lang['news_unsubcribe']		    = 'd&eacute;connecter';
$cms_lang['news_both']					= 'les deux';
$cms_lang['news_headline']				= 'Envoyer les derni&egrave;res nouvelles par courriel.';
$cms_lang['news_headlineback']		    = 'Titre';
$cms_lang['news_subcribemessageback']	= 'Confirmation de connexion';
$cms_lang['news_unsubcribemessageback'] = 'Confirmation de d&eacute;connexion';
$cms_lang['news_subcribemessage']	    = 'Nous avons sauvegarder vos donn&eacute;es dans notre base de donn&eacute;es.';
$cms_lang['news_unsubcribemessage']	   	= 'Vous &ecirc;tes supprim&eacute; de notre lettre d\'information';
$cms_lang['news_stopmessage']		   	= 'La r&eacute;ception de notre lettre d\'information a &eacute;t&eacute; d&eacute;sactiv&eacute;e.';
$cms_lang['news_goonmessage']		   	= 'La r&eacute;ception de notre lettre d\'information a &eacute;t&eacute; activ&eacute;e.';
$cms_lang['news_err_1001']				= 'Vous n\'avez pas entr&eacute; d\'adresse de courrier &eacute;lectronique.';
$cms_lang['news_err_1002']				= 'Le format de l\'adresse de courrier &eacute;lectronique n\'est pas correct.';
$cms_lang['news_err_1003']				= 'Cette adresse de courrier &eacute;lectronique est d&eacute;j&agrave; enregistr&eacute;e.';
$cms_lang['news_err_1004']				= 'L\'adresse de courrier &eacute;lectronique n\'a pas &eacute;t&eacute; trouv&eacute;e.';

$cms_lang['login_error']			    = 'Message d\'erreur';
$cms_lang['login_errormsg']				= 'Donn&eacute;es de connexion incorrectes.';
$cms_lang['login_send']					= 'Connexion';
$cms_lang['login_sendout']				= 'D&eacute;connexion';
$cms_lang['login_name']					= 'Veuillez introduire votre identifiant';
$cms_lang['login_password']				= 'Veuillez introduire votre mot de passe';
$cms_lang['login_login']			    = 'Veuillez cliquer pour vous connecter';
$cms_lang['login_logout']				= 'Veuillez cliquer pour vous d&eacute;connecter';
$cms_lang['login_picforlogout']		    = 'Image pour d&eacute;connexion';

$cms_lang['link_extern']			    = 'lien externe:';
$cms_lang['link_intern']			    = 'ou lien interne:';
$cms_lang['link_blank']					= 'Ouvrir le lien dans une nouvelle fen&ecirc;tre';
$cms_lang['link_self']					= 'Ouvrir le lien dans la m&ecirc;me fen&ecirc;tre';
$cms_lang['link_parent']	  		    = 'Terminer le jeu de cadres actuel lors de l\'ex&eacute;cution du lien';
$cms_lang['link_top']					= 'Terminer tous les jeux de cadres lors de l\'ex&eacute;cution du lien';
$cms_lang['link_edit']					= '&Eacute;diter le lien';

$cms_lang['type_text']					= 'Texte';
$cms_lang['type_textarea']				= 'Textarea';
$cms_lang['type_wysiwyg']				= 'WYSIWYG';
$cms_lang['type_link']					= 'Lien';
$cms_lang['type_file']					= 'Lien de fichier';
$cms_lang['type_image']					= 'Image';
$cms_lang['type_sourcecode']		    = 'Code source';
$cms_lang['type_typegroup']				= 'Contenu';
$cms_lang['type_container']				= 'Contenu';
$cms_lang['type_edit_container']	    = 'Module';
$cms_lang['type_edit_side']				= 'Page';
$cms_lang['type_edit_folder']		    = 'Dossier';
$cms_lang['type_save']					= 'sauvegarder';
$cms_lang['type_edit']					= '&eacute;diter';
$cms_lang['type_new']					= 'nouveau';
$cms_lang['side_new']					= 'cr&eacute;er';
$cms_lang['side_config']			    = 'configurer';
$cms_lang['side_mode']					= 'Mode de vue';
$cms_lang['side_publish']				= 'publier';
$cms_lang['side_delete']			    = 'supprimer';
$cms_lang['side_edit']					= '&Eacute;diter la page';
$cms_lang['side_overview']				= 'Aper&ccedil;u de la page';
$cms_lang['side_preview']				= 'Pr&eacute;visualisation';
$cms_lang['type_delete']			    = 'supprimer';
$cms_lang['type_up']					= 'vers le haut';
$cms_lang['type_down']					= 'vers le bas';

$cms_lang['img_edit']					= 'Changer l\'image';
$cms_lang['imgdescr_edit']				= 'Changer la description de l\'image';
$cms_lang['link_intern']			    = 'lien interne';
$cms_lang['link_extern']			    = 'lien externe';

$cms_lang['err_id']					    = 'Mauvaise ID.';
$cms_lang['err_type']					= 'Mauvais type.';
