...
$cms_lang[$prefix.'_area_delete_directory'] = $cms_lang[$prefix.'_area_index'].' &rsaquo; Verzeichnis löschen';
...
$cms_lang[$prefix.'_area_delete_file'] = $cms_lang[$prefix.'_area_index'].' &rsaquo; Datei löschen';
...
$cms_lang[$prefix.'_area_delete_multiple'] = $cms_lang[$prefix.'_area_index'].' &rsaquo; Auswahl löschen';
...
$cms_lang[$prefix.'_permission_denied'] = 'Nicht genügend Rechte um die Aktion auszuführen!';
...
$cms_lang[$prefix.'_forbidden_directory_name'] = 'Die Verzeichnisname ist unzulässig!';
$cms_lang[$prefix.'_invalid_name_correction_failed'] = 'Der Verzeichnisname ist ungültig und konnte nicht korrigiert werden!';
...
$cms_lang[$prefix.'_save_sub_directories_to_db_failed'] = 'Die Pfade für die Unterverzeichnisse konnten nicht umbenannt werden!';
$cms_lang[$prefix.'_missing_destination_parent_directory'] = 'Kein oder ungültiges Zielverzeichnis angegeben!';
...
$cms_lang[$prefix.'_delete_directory_failed'] = 'Das Verzeichnis konnte nicht gelöscht werden!';
$cms_lang[$prefix.'_delete_directory_from_db_failed'] = 'Das Verzeichnis konnte nicht gelöscht werden!';
...
$cms_lang[$prefix.'_delete_directory_success'] = 'Das Verzeichnis wurde erfolgreich gelöscht!';
$cms_lang[$prefix.'_download_directory_success'] = 'Das Verzeichnis wurde erfolgreich heruntergeladen!';
...
$cms_lang[$prefix.'_forbidden_file_extension'] = 'Die Dateinamenserweiterung ist unzulässig!';
...
$cms_lang[$prefix.'_invalid_filename_correction_failed'] = 'Der Dateiname ist ungültig und konnte nicht korrigiert werden!';
...
$cms_lang[$prefix.'_equal_directories'] = 'Das Quell- und Zielverzeichnis dürfen nicht identisch sein!';
$cms_lang[$prefix.'_move_file_failed'] = 'Die Datei konnte nicht verschoben werden!';
$cms_lang[$prefix.'_delete_file_failed'] = 'Die Datei konnte nicht gelöscht werden!';
$cms_lang[$prefix.'_delete_file_from_db_failed'] = 'Die Datei konnte nicht gelöscht werden!';
...
$cms_lang[$prefix.'_delete_file_success'] = 'Die Datei wurde erfolgreich gelöscht!';
$cms_lang[$prefix.'_download_file_success'] = 'Die Datei wurde erfolgreich heruntergeladen!';
...
$cms_lang[$prefix.'_all_uploads_failed'] = 'Der Upload ist vollständig fehlgeschlagen! Es sind Fehler aufgetreten.';
...
$cms_lang[$prefix.'_delete_thumbnail_failed'] = 'Die Vorschaubilder konnten nicht gelöscht werden!';

$cms_lang[$prefix.'_copy_metadata_success'] = 'Die Metadaten wurden erfolgreich übernommen!';
$cms_lang[$prefix.'_copy_metadata_failed'] = 'Die Metadaten konnten nicht übernommen werden!';

$cms_lang[$prefix.'_add_rights_failed'] = 'Die Rechte konnten nicht angelegt werden!';
$cms_lang[$prefix.'_copy_rights_failed'] = 'Die Rechte konnten nicht übernommen werden!';
$cms_lang[$prefix.'_delete_rights_failed'] = 'Die Rechte konnten nicht gelöscht werden!';
...
$cms_lang[$prefix.'_directory_parentid'] = 'Übergeordnetes Verzeichnis';
...
$cms_lang[$prefix.'_directory_lastmodified'] = 'Geändert';
$cms_lang[$prefix.'_directory_move'] = 'Verzeichnis verschieben';
$cms_lang[$prefix.'_directory_move_label'] = ' Quellverzeichnis nach dem Kopieren löschen? (entspricht verschieben)';
...
$cms_lang[$prefix.'_file_lastmodified'] = 'Geändert';
$cms_lang[$prefix.'_file_filesize'] = 'Dateigröße';
$cms_lang[$prefix.'_file_image_dimension'] = 'Bildgröße';
$cms_lang[$prefix.'_file_thumbnail'] = 'Vorschaubild';
$cms_lang[$prefix.'_file_move'] = 'Datei verschieben';
$cms_lang[$prefix.'_file_move_label'] = ' Quelldatei nach dem Kopieren löschen? (entspricht verschieben)';
...
$cms_lang[$prefix.'_multiple_move_label'] = ' Auswahl nach dem Kopieren löschen? (entspricht verschieben)';
...
$cms_lang[$prefix.'_validation_error_numericNoZero'] = 'Nur Zahlenwerte größer Null sind erlaubt!';
$cms_lang[$prefix.'_validation_error_directoryname'] = 'Verzeichnisname enthält unzulässige Zeichen!';
$cms_lang[$prefix.'_validation_error_filename'] = 'Dateiname enthält unzulässige Zeichen!';



// actions
$cms_lang[$prefix.'_goto_parentdirectory'] = '.. (Verzeichnis aufwärts)';
...
$cms_lang[$prefix.'_delete_directory'] = 'Verzeichnis löschen';
...
$cms_lang[$prefix.'_delete_current_directory'] = 'Aktuelles Verzeichnis löschen';
...
$cms_lang[$prefix.'_preview_file'] = 'Datei öffnen';
...
$cms_lang[$prefix.'_delete_file'] = 'Datei löschen';

$cms_lang[$prefix.'_download_multiple'] = 'Ausgewählte Verzeichnisse und Dateien herunterladen';
$cms_lang[$prefix.'_copy_multiple'] = 'Ausgewählte Verzeichnisse und Dateien kopieren oder verschieben';
$cms_lang[$prefix.'_delete_multiple'] = 'Ausgewählte Verzeichnisse und Dateien löschen';
...
$cms_lang[$prefix.'_upload_totalsize'] = 'Gesamtgröße';
...
$cms_lang[$prefix.'_upload_extract_files'] = 'Komprimierte Dateien (zip, tar) falls möglich entpacken';
$cms_lang[$prefix.'_upload_upload'] = 'Hochladen';
$cms_lang[$prefix.'_upload_cancel'] = 'Abbrechen';
$cms_lang[$prefix.'_upload_nofilesselected'] = 'Keine Dateien ausgewählt. Klicken Sie auf "'.$cms_lang[$prefix.'_upload_browse'].'".';
...
$cms_lang[$prefix.'_upload_close'] = 'Schließen';
...
$cms_lang[$prefix.'_switch_language'] = 'Metadaten übernehmen aus&hellip;';
$cms_lang[$prefix.'_switch_language_confirm'] = 'Sollen wirklich alle Metadaten aus der Sprache \'{selection}\' für die aktuelle Sprache übernommen werden? Alle derzeitigen Metadaten der Datei werden gelöscht! Dieser Vorgang kann nicht rückgängig gemacht werden!';
