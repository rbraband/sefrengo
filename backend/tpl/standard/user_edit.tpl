...
<table class="config" cellspacing="1">
      <tr>
        <td class="header" colspan=2>{LANG_DATA_LOGIN}</td>
      </tr>
      <tr>
...
<!-- END SELECT_SHOWLIST -->        </select></td>
      ...
      <tr>
        <td class="header" colspan=2>{LANG_DATA_PERSON}</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="header" colspan=2>{LANG_DATA_CONTACT}</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="header" colspan=2>{LANG_DATA_FIRM}</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="header" colspan=2>{LANG_DATA_MISC}</td>
      </tr>
      <tr>
       ...
       <tr>
        <td class="header" colspan=2>{LANG_DATA_PROFILE}</td>
      </tr>
      <tr>
