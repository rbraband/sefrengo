...
class SF_ASSETS_DbFile extends SF_LIB_ApiObject {
	var $db;
	var $db_names;
	...
	function _buildPathes() {
		global $cfg_client, $cfg_cms;
		$this->data['mixed']['filepath_relative'] = $cfg_client['path_rel'] . $cfg_client['path_fm_rel']
														. $this->data['directory']['dirname'].$this->data['file']['filename'];
		$this->data['mixed']['filepath_absolute'] = $cfg_cms['path_base'] . $cfg_client['path_rel'] . $cfg_client['path_fm_rel'].$this->data['directory']['dirname'].$this->data['file']['filename'];
		$this->data['mixed']['dirpath_absolute'] = $cfg_cms['path_base'] . $cfg_client['path_rel'] . $cfg_client['path_fm_rel'].$this->data['directory']['dirname'];
		$this->data['mixed']['httpdirpath_relative']= $cfg_client['path_rel'] . $cfg_client['path_fm_rel']
		...
		$this->data['mixed']['httppath_absolute'] = $cfg_client['path_http'] . $cfg_client['path_rel']  . $cfg_client['path_fm_rel'] .$this->data['directory']['dirname'].$this->data['file']['filename'];
	}
}
