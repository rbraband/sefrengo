<?php
// File: $Id: class.SF_ASSETS_DbFileAddonFactory.php 29 2008-05-11 19:19:53Z mistral $
// +----------------------------------------------------------------------+
...
// + ToDo:
// +----------------------------------------------------------------------+
class SF_ASSETS_DbFileAddonFactory extends SF_LIB_ApiObject {
	var $fileobject;
...
class SF_ASSETS_DbFileAddon extends SF_LIB_ApiObject {
	var $fileobject;
