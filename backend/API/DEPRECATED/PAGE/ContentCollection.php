<?php
// File: $Id: class.SF_PAGE_ContentCollection.php 74 2008-11-25 21:16:29Z bjoern $
// +----------------------------------------------------------------------+
...
// + ToDo:
// +----------------------------------------------------------------------+
class SF_PAGE_ContentCollection extends SF_LIB_ApiObject {
  //privat
    /**
    * Class Name
    *
  ...
  //public
    ...
    */
    function SF_PAGE_ContentCollection() {
        ...
        //include_once($cfg_cms['path_base'].$cfg_cms['path_backend_rel'].'inc/fnc.type_common.php');
