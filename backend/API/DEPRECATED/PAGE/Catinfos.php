<?php
class SF_PAGE_Catinfos extends SF_LIB_ApiObject {
    ...
    function generate() {
    	global $cfg_client, $perm, $db, $cms_db, $client, $auth;
    ...
    function getStartpageIsHttps($idcat) { return $this->data['data'][$idcat]['description']; }
