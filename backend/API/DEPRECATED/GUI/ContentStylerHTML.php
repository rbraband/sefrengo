<?php
// File: $Id: class.SF_GUI_ContentStylerHTML.php 74 2008-11-25 21:16:29Z bjoern $
// +----------------------------------------------------------------------+
...
class SF_GUI_ContentStylerHTML extends SF_GUI_ContentStylerPlain {
  //privat
    ...
    * Object version
    *
    * This string identify the SF_LIB_ApiObject Version.
    *
    * @param  string
    */
    var $_API_object_version = '$Revision: 74 $';
    	...
    	if (preg_match_all('#^cms://(idfile|idfilethumb)=(\d+)#', $mod_content, $match) ) {
    		...
    		if ($db->next_record()){
    			...
    			if ( ($type_config['mode'] == 'thumb' && $pic_filetype != 'gif' && ($thumb_x != 0 || $thumb_y != 0) )
    				...
    				$mod_path = $sf_cfg->env('path_frontend_fm_http').$db->f('dirname').$new_name;
