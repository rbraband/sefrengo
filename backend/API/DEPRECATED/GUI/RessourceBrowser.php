<?php
// File: $Id: class.SF_GUI_RessourceBrowser.php 74 2008-11-25 21:16:29Z bjoern $
// +----------------------------------------------------------------------+
...
// + ToDo:
// +----------------------------------------------------------------------+
class SF_GUI_RessourceBrowser extends SF_LIB_ApiObject{
	...
	function exportConfigURL($display='outer', $detail_switch_mode='list', $custom_resource_config = null, $display_action = null, $item_position=null) {
		...
		$url_frontend = str_replace(array('{%http_host}', '{%request_uri}' ), array($_SERVER['HTTP_HOST'], $_SERVER['QUERY_STRING']), $this->cfg_client['path_http_edit']);
		$url = $url_frontend.$this->cfg_client['path_rel'].'cms/inc/inc.ressource_browser.php?rb_conf='.
	...
	function getOuterDialog() {
		...
		$tpl_gvars['rbCssPath'] = $this->cfg['path_base_http'] . $this->cfg['path_backend_rel'] .'tpl/'.$this->cfg['skin'].'/css/';
		$tpl_gvars['rbImagePath'] = $this->cfg['path_base_http'] . $this->cfg['path_backend_rel'] .'tpl/'. $this->cfg['skin'].'/img/ressource_browser/';
		...
		foreach ($this->_ressources AS $v) {
			...
			$tpl_vars['rbImagePath'] = $this->cfg['path_base_http'] . $this->cfg['path_backend_rel'] .'tpl/'. $this->cfg['skin'].'/img/ressource_browser/';
	...
	function getInnerDialog() {
		...
		$tpl_global_vars['rbCssPath'] = $this->cfg['path_base_http'] . $this->cfg['path_backend_rel'] .'tpl/'.$this->cfg['skin'].'/css/';
		$tpl_global_vars['rbImagePath'] =$this->cfg['path_base_http'] . $this->cfg['path_backend_rel'] .'tpl/'. $this->cfg['skin'].'/img/ressource_browser/';
	...
	function _getIcon($identifier, $type = null) {
		$image_path = $this->cfg['path_base_http'] . $this->cfg['path_backend_rel'] .'tpl/'. $this->cfg['skin'].'/img/ressource_browser/';
