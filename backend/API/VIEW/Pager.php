<?php
class SF_VIEW_Pager extends SF_LIB_ApiObject
{	
	private $pager;
	...
	private $data = array('total_items' => 0,
						'links' => array(),
						'items_per_page' => 10,
						'delta' => 2,
						'current_page' => 1,
	...
	{
		$this->data['total_items'] = (int) $items;
	}
	
	public function setItemsPerPage($items)
	{
		$this->data['items_per_page'] = (int) $items;
	}
	
	public function setDelta($delta)
	{
		$this->data['delta'] = (int) $delta;
	}
	
	public function setCurrentPage($page)
	{
		$this->data['current_page'] = (int) $page;
	}
	
	public function setUrlVar($v)
	{
		$this->data['url_var'] =  $v;
	}
	
	public function setTextPrev($v)
	{
		$this->data['text_prev'] =  $v;
	}
	
	public function setTextNext($v)
	{
		$this->data['text_next'] =  $v;
	}
	
	public function setTextFirst($v)
	{
		$this->data['text_first'] =  $v;
	}
	
	public function setTextLast($v)
	{
		$this->data['text_last'] =  $v;
	}
	
	public function setSpacesBeforeSeparator($v)
	{
		$this->data['spaces_before_separator'] =  (int) $v;
	}
	
	public function setSeparator($v)
	{
		$this->data['separator'] =  $v;
	}
	
	public function setLinkClass($v)
	{
		$this->data['link_class'] =  $v;
	}
	
	public function setClassCurrentSpan($v)
	{
		$this->data['class_current_span'] =  $v;
	}
	
	public function setExecludeVars($v)
	{
		$this->data['execlude_vars'] =  $v;
	}
	...
	public function generate()
	{
		...
		// 'expanded' => '', // [boolean]// if TRUE, window size is always 2*delta+1
		 'linkClass' => $this->data['link_class'], // [string]// Name of CSS class used for link styling.
	...
	public function getLinks()
	{
	    ...
	    {
	    	$temp .= $this->data['links']['first'].$this->data['separator'];	    
	    }
	    if ( $this->data['links']['back'] != "" )
	    {
	    	$temp .= $this->data['links']['back'].$this->data['separator'];	    
	    }
